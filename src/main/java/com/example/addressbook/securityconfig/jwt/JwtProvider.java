package com.example.addressbook.securityconfig.jwt;
...
public class JwtProvider{
    ...
    @Autowired
    public JwtProvider(@Value("${security.jwt.token.secret-key:======================BezKoder=Spring===========================}") String secretKey,
                       @Value("${security.jwt.token.expiration:86400000}")long validityInMilliseconds) {
